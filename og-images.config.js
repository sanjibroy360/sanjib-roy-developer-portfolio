      ...
      <div style=${styles.wrap}>
        ...
        >
          ...
          <div style="margin-top: 40px; display: flex; flex-direction: column;">
            <p
              style="color: #f7f7f7; text-shadow: 0.15em 0.15em 0.5em #00111ad9; font-size: 35px; margin-top: 0; font-weight: 800;"
            >
              By ${author}
            </p>
            <p
              style="font-size: 36px; text-shadow: 0.15em 0.15em 0.5em #00111ad9; font-weight: 800; margin-top: 0; color: #f7f7f7;"
            >
              On ${publishedOn}
            </p>
          </div>
